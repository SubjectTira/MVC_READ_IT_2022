                    ...
                    <div class="text p-4 float-right d-block">
                    	<div class="topper d-flex align-items-center">
                    		<div class="one py-2 pl-3 pr-1 align-self-stretch">
                    			<span class="day"><?php echo getFormattedDate($post['created_at'], 'd') ?></span>
                    		</div>
                    		<div class="two pl-0 pr-3 py-2 align-self-stretch">
                    			<span class="yr"><?php echo getFormattedDate($post['created_at'], 'F') ?></span>
                    			<span class="mos"><?php echo getFormattedDate($post['created_at'], 'Y') ?></span>
                    		</div>
                    	</div>
